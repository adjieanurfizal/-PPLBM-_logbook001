...
class AccessControlService {
  // Mengambil roles dari .env, default ke 'Anggota'
  ...
  // Matrix perizinan (Ketua vs Anggota)
  ...
  static bool canPerform(String role, String action, {bool isOwner = false}) {
    ...
    // Logic khusus kepemilikan data (Anggota hanya bisa Edit/Delete miliknya sendiri)
    if (role == 'Anggota' &&
